...
public class RotationUtils
{
	...
	static public readonly Vector3 DIRECTION_VECTOR_ZERO = Vector3.zero;
	static public readonly Vector3 DIRECTION_VECTOR_RIGHT = Vector3.right;
	static public readonly Vector3 DIRECTION_VECTOR_UP_RIGHT = Vector3.forward + Vector3.right;
	static public readonly Vector3 DIRECTION_VECTOR_UP = Vector3.forward;
	static public readonly Vector3 DIRECTION_VECTOR_UP_LEFT = Vector3.forward + Vector3.left;
	static public readonly Vector3 DIRECTION_VECTOR_LEFT = Vector3.left;
	static public readonly Vector3 DIRECTION_VECTOR_DOWN_LEFT = Vector3.back + Vector3.left;
	static public readonly Vector3 DIRECTION_VECTOR_DOWN = Vector3.back;
	static public readonly Vector3 DIRECTION_VECTOR_DOWN_RIGHT = Vector3.back + Vector3.right;

	static public readonly Vector3 AXIS_VECTOR_NONE = Vector3.zero;
	static public readonly Vector3 AXIS_VECTOR_X = Vector3.right;
	static public readonly Vector3 AXIS_VECTOR_X_NEG = Vector3.left;
	static public readonly Vector3 AXIS_VECTOR_Y = Vector3.up;
	static public readonly Vector3 AXIS_VECTOR_Y_NEG = Vector3.down;
	static public readonly Vector3 AXIS_VECTOR_Z = Vector3.forward;
	static public readonly Vector3 AXIS_VECTOR_Z_NEG = Vector3.back;
	static public readonly Vector3 AXIS_VECTOR_XY = Vector3.right + Vector3.up;
	static public readonly Vector3 AXIS_VECTOR_XY_NEG = Vector3.left + Vector3.down;
	static public readonly Vector3 AXIS_VECTOR_XZ = Vector3.right + Vector3.forward;
	static public readonly Vector3 AXIS_VECTOR_XZ_NEG = Vector3.left + Vector3.back;
	static public readonly Vector3 AXIS_VECTOR_YZ = Vector3.up + Vector3.forward;
	static public readonly Vector3 AXIS_VECTOR_YZ_NEG = Vector3.down + Vector3.back;
	static public readonly Vector3 AXIS_VECTOR_XYZ = Vector3.right + Vector3.up + Vector3.forward;
	static public readonly Vector3 AXIS_VECTOR_XYZ_NEG = Vector3.left + Vector3.down + Vector3.back;

	static private readonly Vector3[] DIRECTION_VECTORS = new Vector3[] 
	{
	...
	static private readonly Vector3[] AXIS_VECTORS = new Vector3[] 
	{ 
	...
	static private Hashtable _directionAngles;
	static private Hashtable _angleDirectionEnums;
	static private Hashtable _angleDirectionVectors;

	static private Hashtable _axisEnums;
	static private Hashtable _axisVectors;

	#endregion

	#region Lazy Loading

	static private Hashtable directionAngles
	{
		get
		{
	...
	static private Hashtable angleDirectionEnums
	{
		get
		{
	...
	static private Hashtable angleDirectionVectors
	{
		get
		{
	...
	static private Hashtable axisEnums
	{
		get
		{
			if ( _axisEnums == null )
	...
	static private Hashtable axisVectors
	{
		get
		{
	...
	static public float GetReverseAngle( float degrees )
	{
	...
	static public float NormalizeDegrees0To360( float degrees )
	{
	 ...
	 * (e.g. 405 degrees returns 45 degrees) 
	 * (e.g. -45 degrees returns 315 degrees) */
	static public void NormalizeDegrees0To360( Vector3 degrees, out Vector3 outVector )
	{
	...
	static public Quaternion MirrorXAxis( Quaternion quaternion )
	{
	 ...
	 * This is a way of flipping between LHS and RHS coordinate systems. */
	static public Quaternion MirrorYAxis( Quaternion quaternion )
	{
		return new Quaternion( quaternion.x, -quaternion.y, quaternion.z, -quaternion.w );
	}
	 ...
	 * This is a way of flipping between LHS and RHS coordinate systems. */
	static public Quaternion MirrorZAxis( Quaternion quaternion )
	{
		return new Quaternion( quaternion.x, quaternion.y, -quaternion.z, -quaternion.w );
	}
	...
	#region Direction Rounding

	/** Rounds a direction vector to the nearest cardinal.
	 * NOTE: This includes diagonals. */
	static public void RoundDirectionVector( Vector3 inDirection, out Vector3 outDirection )
	{
		...
		outDirection.x = (MathUtils.IsEqual( x, 1.0f ) || MathUtils.IsEqual( x, -1.0f )) ? x : 0.0f;
		outDirection.y = (MathUtils.IsEqual( y, 1.0f ) || MathUtils.IsEqual( y, -1.0f )) ? y : 0.0f;
		outDirection.z = (MathUtils.IsEqual( z, 1.0f ) || MathUtils.IsEqual( z, -1.0f )) ? z : 0.0f;
	}

	#endregion

	#region Axis Rotations
	...
	static public void GetXAxisRotation( Vector3 direction, out Vector3 eulerAngle )
	{
	 ...
	 * NOTE: Direction vectors will be rounded to the nearest cardinal. */
	static public void GetYAxisRotation( Vector3 direction, out Vector3 eulerAngle )
	{
	 ...
	 * NOTE: Direction vectors will be rounded to the nearest cardinal. */
	static public void GetZAxisRotation( Vector3 direction, out Vector3 eulerAngle )
	{
	...
	#region Angle To Direction | Direction to Angle

	/** Returns the rotation angle (in degrees) of a direction vector. 
	 * (e.g. <0, 0, 1> returns 90 degrees) */
	static public float GetDirectionAngle( Vector3 direction )
	{
		RoundDirectionVector( direction, out direction );
	...
	static public Direction GetAngleDirection( float degrees )
	{
	...
	static public void GetAngleDirectionVector( float degrees, out Vector3 direction )
	{
	...
	#region Axis To Direction | Direction to Axis
	...
	static public void GetAxisDirectionVector( Axis axis, out Vector3 direction )
	{
	...
	static public Axis GetDirectionVectorAxis( Vector3 direction )
	{
		RoundDirectionVector( direction, out direction );
